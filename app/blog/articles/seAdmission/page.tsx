    ...
    <>
      ...
      <div className="animate-fade-in-length0.25s my-20 mx-[15%] max-w-250 flex flex-col gap-5">
        <div className="flex flex-col gap-5">
          ...
          <h3 className="font-serif text-gray-300 text-3xl">My personal advice for UW SE applicants</h3>
          <p className="-mt-2.5 mb-2.5 font-serif text-gray-400 text-2xl">June 10, 2026</p>
        </div>
        <hr />
        <div className="flex flex-col gap-2.5 text-lg">
          ...
          <p>
            <b>At least a 97% engineering top 6 average.</b> There are a number of people with
            Governor General's Bronze Medals.{/* hyperlink the eng top 6 here later */}
          </p>
          <p>
          ...
          <p> {/* hyperlink the u of t program thing to include a source */}
            <b>If you are applying to U of T, rank every U of T program at the top on OUAC.</b> Waterloo does NOT care
            where you rank them on OUAC, but for some reason, U of T does. This isn't technically UW SE admissions advice,
            but it's worth mentioning just in case anyone doesn't know.
          </p>
          <p>

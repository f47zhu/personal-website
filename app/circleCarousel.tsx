...
export function CircleCarousel({ isPopUps = false, images }:
  ...
  return (
    <div
      ...
      onClick={() => {if (isPopUps) {togglePause();}}}
    >
      <div
        className="z-20 flex flex-row absolute bottom-1/12 m-auto left-0 right-0 place-content-center opacity-0 group-hover:opacity-100 transition ease-in-out"
